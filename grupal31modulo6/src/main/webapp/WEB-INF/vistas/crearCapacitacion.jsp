            ...
            <div class="relative flex flex-col md:flex-row">
                ...
                <div class="max-w-2xl mb-1">
                        ...
                        <div class="container mx-auto flex flex-wrap items-center justify-between">
                            ...
                            <div class="hidden md:block w-full md:w-auto" id="mobile-menu">
                                <ul
                                    ...
                                    <li>
                                        <a href="${pageContext.request.contextPath}/" class="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 
                    block pl-3 pr-4 py-2 md:hover:text-indigo-700 md:p-0">Inicio</a>
                                        ...
                                        <div id="dropdownNavbar"
                                            ...
                                            <ul class="py-1" aria-labelledby="dropdownLargeButton">
                                                ...
                                                <c:if test="${sessionScope.usuario=='CLIENTE'}">
                                                    <li>
                                                        <a href="${pageContext.request.contextPath}/listarCapacitaciones" name="listarCapacitacion"
                                                ...
                                                <li>
                                                    <a href="#" name="listarAsesorias"
                                                        class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                       Listado de Asesorias
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#" name="listarVisitas"
                                                        class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                       Listado de Visitas
                                                    </a>
                                                </li>
                                            ...
                                            <c:if test="${sessionScope.usuario=='ADMINISTRATIVO'}">
                                                <li>
                                                    <a href="#" name="listarUsuarios"
                                                        class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                       Listado de Usuarios
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#" name="listarPagos"
                                                        class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                       Listado de Pagos
                                                    </a>
                                                </li>
                                    ...
                                    <li>
                                        ...
                                        <div id="dropdownNavbar1"
                                            ...
                                            <ul class="py-1" aria-labelledby="dropdownLargeButton">
                                                ...
                                                <c:if test="${sessionScope.usuario=='CLIENTE'}">
                                                    <li>
                                                        <a href="${pageContext.request.contextPath}/crearCapacitacion" name="crearCapacitacion"
                                                            class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                            Crear Capacitación
                                                        </a>
                                                    </li>
                                                ...
                                                <c:if test="${sessionScope.usuario=='ADMINISTRATIVO'}">
                                                <li>
                                                    <a href="#" name="crearUsuario"
                                                        class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                        Crear Usuario
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="#" name="crearPago"
                                                        class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                        Crear Pago
                                                    </a>
                                                </li>
                                    ...
                                    <li>
                                        ...
                                        <div id="dropdownNavbar2"
                                            ...
                                            <ul class="py-1" aria-labelledby="dropdownLargeButton">
                                                ...
                                                <c:if test="${sessionScope.usuario=='CLIENTE'}">
                                                    <li>
                                                        <a href="#" name="adminAsistentes"
                                                            class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                            Administrar Asistentes</a>
                                                    </li>
                                                    <li>
                                                        <a href="#" name="gestAccidentes"
                                                            class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                ...
                                                <c:if test="${sessionScope.usuario=='PROFESIONAL'}">
                                                    <li>
                                                        <a href="#" name="responderCheckList"
                                                            class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                            Responder CheckList</a>
                                                    </li>
                                                    <li>
                                                        <a href="#" name="reportes"
                                                            class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                            Reportes</a>
                                                    </li>
                                                </c:if>
                                                ...
                                                <c:if test="${sessionScope.usuario=='ADMINISTRATIVO'}">
                                                    <li>
                                                        <a href="#" name="editarAdministrativo"
                                                            class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                            Editar Administrativo</a>
                                                    </li>
                                                    <li>
                                                        <a href="#" name="editarCliente"
                                                            class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                            Editar Cliente</a>
                                                    </li>
                                                    <li>
                                                        <a href="#" name="editarProfesional"
                                                            class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                                            Editar Profesional</a>
                                                    </li>
                                                    <li>
                                                        <a href="#" name="adminChequeos"
                                                            class="text-sm hover:bg-gray-50 text-indigo-700 hover:text-teal-600 block px-4 py-2">
                                    ...
                                    <c:if test="${sessionScope.usuario=='CLIENTE'}">
                                        <li>
                                            <a href="${pageContext.request.contextPath}/contacto" class="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 
